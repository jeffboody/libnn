...
glslangValidator -V nn_convLayer_backpropT_dL_dW_dB.comp -o nn_convLayer_backpropT_dL_dW_dB_comp.spv
...
bfs $1 blobSet nn/shaders/nn_convLayer_backpropT_dL_dW_dB_comp.spv
